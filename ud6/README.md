...
| `EMIN_Nesting_Lab_v1.8.html` | Nesting Lab v1.8 — писач + разкрой с 6 стратегии, история, машинно време, резерв, прагове, ред на рязане по път: бутони „UD6 — текущия лист“ / „ZIP UD6 — всички листове“ |
