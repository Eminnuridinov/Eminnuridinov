...
| `EMIN_Nesting_Lab_v1.7.html` | Nesting Lab v1.7 — писач + разкрой с 6 стратегии, история на поръчките, машинно време, резерв, прагове: бутони „UD6 — текущия лист“ / „ZIP UD6 — всички листове“ |
