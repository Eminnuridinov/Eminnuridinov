...
| `EMIN_Nesting_Lab_v1.6.html` | Nesting Lab v1.6 с вграден писач (червен слой, kerf по ID, застъпване, редактируеми позиции, 6 стратегии за разкрой): бутони „UD6 — текущия лист“ / „ZIP UD6 — всички листове“ |
